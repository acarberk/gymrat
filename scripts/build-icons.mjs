...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${size} ${size}">
  ...
  <g transform="translate(${size * 0.18 + padding}, ${size * 0.34 + padding}) scale(${(size * 0.64 - padding * 2) / 64})">
    <path d="M0 12h12v40H0zM52 12h12v40H52zM12 26h40v12H12z" fill="#22d3ee"/>
  </g>
</svg>
`);
